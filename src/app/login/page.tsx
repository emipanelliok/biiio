    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center px-8 bg-[#fcf9f8]">
        <div className="w-full max-w-md">
          ...
          <h2 className="font-black text-3xl tracking-tighter text-[#1a1c1c] mb-2">Sign in</h2>
          ...
          <form className="flex flex-col gap-5">
            <div className="flex flex-col gap-1.5">
              ...
              <input type="email" placeholder="curator@biiio.io" className="bg-[#f3f3f3] border-none rounded-2xl px-4 py-3.5 text-sm font-medium text-[#1a1c1c] placeholder:text-[#cdc3d0] focus:outline-none focus:ring-2 focus:ring-[#d2aef8]" />
            </div>
            <div className="flex flex-col gap-1.5">
              ...
              <input type="password" placeholder="••••••••" className="bg-[#f3f3f3] border-none rounded-2xl px-4 py-3.5 text-sm font-medium text-[#1a1c1c] focus:outline-none focus:ring-2 focus:ring-[#d2aef8]" />
            </div>
            <Link href="/dashboard" className="w-full py-4 bg-[#d2aef8] text-[#1c1b1b] rounded-full font-black text-sm text-center hover:opacity-90 transition-opacity shadow-lg shadow-[#d2aef8]/30 mt-2">
              Login →
            </Link>
          </form>
          ...
          <p className="text-center text-sm text-[#7c7480] mt-6">
            ...
            <Link href="/onboarding" className="text-[#d2aef8] font-black hover:opacity-70 transition-opacity">Sign up</Link>
          </p>
        </div>
      </div>
    </div>
